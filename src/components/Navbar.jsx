...
// // const NAV_LINKS = ['Home', 'Men', 'Women', 'New Arrivals', 'Sale', 'Contact']
...
// //         scrolled ? 'bg-bone/95 backdrop-blur-sm shadow-[0_1px_0_0_rgba(20,19,15,0.08)]' : 'bg-transparent'
// //       }`}
// //     >
...
// //                 className="relative pb-1 after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[1px] after:w-0 after:bg-oxblood after:transition-all after:duration-300 hover:after:w-full"
// //               >
// //                 {item}
// //               </a>
// //             </li>
...
// //           {NAV_LINKS.map((item) => (
// //             <li key={item} className="text-sm font-semibold uppercase tracking-widest2">
