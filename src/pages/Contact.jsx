              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-lg">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-b border-ink/20 bg-transparent py-2.5 text-sm text-ink outline-none focus:border-oxblood transition-colors disabled:opacity-50"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    disabled={status === 'sending'}
                    className="w-full border-b border-ink/20 bg-transparent py-2.5 text-sm text-ink outline-none focus:border-oxblood transition-colors resize-none disabled:opacity-50"
                  />
                </div>

                {status === 'error' && (
                  <p className="text-sm text-oxblood">{errorMessage}</p>
                )}

                <button
                  type="submit"
                  disabled={status === 'sending'}
                  className="mt-2 inline-flex w-fit items-center border border-ink px-8 py-3.5 text-[11px] font-semibold uppercase tracking-widest2 transition-colors duration-300 hover:bg-ink hover:text-bone disabled:opacity-50 disabled:cursor-not-allowed"
                >
